...
from grafo import gerar_grafo_como_lista_adjacencia, desenhar_grafo
...
def main():
    ...
    for arquivo in os.listdir(pasta):
        if arquivo.endswith(".dat"):  # Verifica se o arquivo tem extensão .dat
            ...
            desenhar_grafo(grafo, nome_arquivo, vertices_requeridos, arestas_requeridas, arcos_requeridos)
